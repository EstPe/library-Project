...
export class ProductDetailsComponent implements OnInit {
  ...
  constructor(private acRout: ActivatedRoute, private CategoriesService: CategoriesService) { }

  list_of_category: category_of_books[] = [];
  currentCategorie = new category_of_books(0, "", 0, "", "", "");
  getProducts() {
    this.CategoriesService.getProducts().subscribe((data: category_of_books[]) => {
